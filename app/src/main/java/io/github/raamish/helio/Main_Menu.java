        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                   ...
                   /* else  if (result.get(0).equalsIgnoreCase("call Vaibhav"))
                    {
                        //Toast.makeText(QuickLinks.this, "Calling Vaibhav", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(Intent.ACTION_DIAL);
                        intent.setData(Uri.parse("tel:7011201253"));
                        startActivity(intent);
                    }
                    else  if (result.get(0).equalsIgnoreCase("call Ruchir"))
                    {
                        //Toast.makeText(QuickLinks.this, "Calling Vaibhav", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(Intent.ACTION_DIAL);
                        intent.setData(Uri.parse("tel:7002894335"));
                        startActivity(intent);
                    }
                    */
                    else {
                        ...
                        switch (firstWord) {
                           ...
                           //    break;
                            case "call":
                                ...
                                in.setData(Uri.parse("tel:7011201253"));
                                startActivity(in);
                                break;
